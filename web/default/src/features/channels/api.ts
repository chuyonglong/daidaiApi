...
/**
 * Create multiple fully configured channels from a JSON array
 */
export async function batchCreateChannels(
  data: BatchCreateChannelInput[]
): Promise<BatchCreateChannelsResponse> {
  const res = await api.post('/api/channel/batch_create', data)
  return res.data
}
