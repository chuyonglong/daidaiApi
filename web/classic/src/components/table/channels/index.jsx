...
import BatchCreateChannelsModal from './modals/BatchCreateChannelsModal';
...
const ChannelsPage = () => {
  ...
  return (
    <>
      ...
      <BatchCreateChannelsModal
        visible={channelsData.showBatchCreate}
        onCancel={() => channelsData.setShowBatchCreate(false)}
