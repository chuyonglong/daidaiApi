...
func InitOptionMap() {
	...
	common.OptionMap["AutomaticRetryErrorCodes"] = operation_setting.AutomaticRetryErrorCodesToString()
	common.OptionMap["AutomaticRetryErrorKeywords"] = operation_setting.AutomaticRetryErrorKeywordsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AutomaticRetryErrorCodes":
		err = operation_setting.AutomaticRetryErrorCodesFromString(value)
	case "AutomaticRetryErrorKeywords":
		operation_setting.AutomaticRetryErrorKeywordsFromString(value)
