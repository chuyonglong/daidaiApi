...
func uniqueChannelAffinityUsageTestID(t *testing.T, suffix string) string {
	t.Helper()
	return strings.NewReplacer("/", "_", " ", "_").Replace(t.Name() + "_" + suffix)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityUsageTestID(t, "rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityUsageTestID(t, "fp")
